...
export function WhatsAppFAB() {
  return (
    <motion.a
      ...
      whileTap={{ scale: 0.95 }}
      className="fixed bottom-5 right-5 z-50 w-14 h-14 flex items-center justify-center bg-[#25D366] hover:bg-[#20b858] text-white shadow-luxe rounded-full transition-colors"
      aria-label="Pedir por WhatsApp"
    >
      <span className="absolute inset-0 rounded-full bg-[#25D366]/40 animate-ping" />
      <svg viewBox="0 0 32 32" className="w-7 h-7 relative shrink-0" fill="currentColor">
